...
public class Inserir_Compras_Efetuadas extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void mostraComprasEfetuadasSpinner(Cursor cursorComprasEfetuadas) {
        SimpleCursorAdapter adaptadorComprasEfetuadas = new SimpleCursorAdapter(
                ...
                new String[]{BdTableCategorias.QUANTIDADE},
    ...
    private void guardar() {
        ...
        // guardar os dados
        Categorias comprasEfetuadas = new Categorias();

        comprasEfetuadas.setQuantidade(quantidade);

        try {
            getContentResolver().insert(Compras_Efetuadas_ContentProvider.ENDERECO_CATEGORIAS, comprasEfetuadas.getContentValues());
  ...
  /*  @NonNull
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        androidx.loader.content.CursorLoader cursorLoader = new androidx.loader.content.CursorLoader(this, Compras_Efetuadas_ContentProvider.ENDERECO_CATEGORIAS, BdTableCategorias.TODAS_COLUNAS, null, null, BdTableCategorias.QUANTIDADE
        );
